    ...
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <div className="group relative bg-white dark:bg-black rounded-lg shadow-solid-10 dark:shadow-none border border-stroke dark:border-black p-7.5 xl:p-12.5">
          ...
          <p className='text-[rgb(117_118_147)]'>Good for 1 to 100 Domains</p>

          <div className="border-t border-stroke dark:border-black mt-9 pt-9 pb-12.5">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi incidunt in omnis, reiciendis inventore, dolorum sit culpa eligendi architecto, nam veniam ipsam illo sint. Sunt fugiat quas labore ex assumenda.
          </div>
          ...
          >
            <button type='button' className="hover:pr-2 duration-500"> Activate</button>
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
