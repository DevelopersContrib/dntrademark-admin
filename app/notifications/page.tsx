      ...
      <div className="w-full">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="w-full flex flex-col max-h-[500px] overflow-y-auto">
            <a href="" className="py-2 px-4 md:px-6 xl:px-7.5 no-underline hover:bg-gray-2 flex items-center justify-between">
              <span className="capitalize font-medium">&middot; Lorem ipsum dolor, sit amet consectetur adipisicing elit. </span>
