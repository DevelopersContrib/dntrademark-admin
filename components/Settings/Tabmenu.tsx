...
import NotificationSettings from '@/components/Settings/NotificationAccountSettings'
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark mb-5">
        <div className="mb-4 p-7.5 w-full">
          <div className="mb-7.5 flex flex-wrap gap-3 rounded-lg border border-stroke py-3 px-4 dark:border-strokedark">
            ...
            <button
              className={`bg-gray dark:bg-meta-4 text-black dark:text-white rounded-md py-3 px-4 text-sm font-medium hover:bg-danger hover:text-white dark:hover:bg-danger md:text-base lg:px-6 nav-tabs hidden ${
                activeTab === 2 ? "active" : ""
              }`}
          ...
          <div>
            ...
            {activeTab === 5 && (
              <>
                <NotificationSettings userdetails={userdetails.userdetails} />
              </>
            )}
          </div>
        </div>
