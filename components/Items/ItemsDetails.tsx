        ...
        <div>
              ...
              <ol className="flex items-center gap-2">
                ...
                <li>
                  <a
                    ...
                    href={"/domains/items/" + row.domain_id}
                  >
          ...
          <div className="flex flex-col gap-8">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="border-b border-stroke px-4 py-4 dark:border-strokedark sm:px-6 xl:px-7.5 flex w-full justify-between">
                  ...
                  <button
                    onClick={() => {
                      const getTargetElement = () =>
                        document.getElementById("for-print");
                      generatePDF(getTargetElement, {
                        filename: row.serial_number + ".pdf",
                      });
                    }}
                ...
                <table className="w-full table-auto table-border-boxed ">
                  <tbody>
                    <tr>
                      ...
                      <td className="">{row.keyword}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Registration Number:
                      </td>
                      <td className="">{row.registration_number}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Serial Number:
                      </td>
                      <td className="">{row.serial_number}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Status Label:
                      </td>
                      <td className="">{row.status_label}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="">{row.status_date}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="">{row.status_definition}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Filing Date:
                      </td>
                      <td className="">{row.filing_date}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Registration Date:
                      </td>
                      <td className="">{row.registration_date}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Abandonment Date:
                      </td>
                      <td className="">{row.abandonment_date}</td>
                    </tr>
                    <tr>
                      <td className=" font-semibold" width={200}>
                        Expiration Date:
                      </td>
                      <td className="">{row.expiration_date}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="">{row.updated_at}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full table-auto table-border-boxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{owner.legal_entity_type}</td>
                      <td>
                        {owner.address1}, {owner.city}, {owner.state}, ,{" "}
                        {owner.country}, , {owner.postcode}
                      </td>
                    </tr>
                  </tbody>
                </table>
