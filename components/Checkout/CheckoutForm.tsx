        ...
        {success ? (
          <div className="flex w-full border-l-6 border-[#009ef7] bg-[#f1faff] bg-opacity-[15%] dark:bg-[#f1faff] px-7 py-8 shadow-md  md:p-9">
            ...
            <div className="w-full">
              <h5 className="mb-3 text-lg font-bold text-black dark:text-[#009ef7]">Payment Success</h5>
              <p className="text-base leading-relaxed text-body">You are being redirected to the onboarding page...</p>
            </div>
          </div>
        ) : (
          <>
            <div className=" rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-4 md:p-6 xl:p-9">
                <h3 className="text-black dark:text-white font-bold text-3xl xl:text-title-xxl mb-0">
                  ${pack.price}
                  <span className="text-regular text-[rgb(117_118_147)] dark:text-manatee inline leading-[55px] text-lg">/month</span>
                </h3>
                <h4 className="text-black dark:text-white font-medium text-2xl mb-2.5">{pack.name}</h4>
                <p className="text-[rgb(117_118_147)]">
                  Good for {pack.start_limit} to {pack.end_limit} Domains
                </p>
              </div>
            </div>
